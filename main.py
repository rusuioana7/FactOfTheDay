...
def search_result_window():
    ...
    def display_news(news):
        ...
        # description
        description_label = tk.Label(result_frame, text="Description: " + news['description'], font=("Souvenir", 12),
                                     bg="#c4f1be", fg="#525B76", wraplength=400, justify="left")
        description_label.grid(row=1, column=0, sticky="w", padx=10, pady=10)
        # source
        source_label = tk.Label(result_frame, text="Source: " + news['source'], font=("Souvenir", 12), bg="#c4f1be",
                                fg="#525B76")
        source_label.grid(row=2, column=0, sticky="w", padx=10, pady=5)
        # date
        date_label = tk.Label(result_frame, text="Date of publishing: " + news['published_date'], font=("Souvenir", 12),
                              bg="#c4f1be", fg="#525B76")
...
def run_app():
    ...
    topic_label = tk.Label(root, text="Topic that your interested in:", font=("Souvenir", 18), bg="#525B76",
                           fg="#c4f1be")
    ...
    submit_button = tk.Button(root, text="Submit", bg="#201e50", fg="#c4f1be", command=search_result_window, width=12,
                              height=1)
